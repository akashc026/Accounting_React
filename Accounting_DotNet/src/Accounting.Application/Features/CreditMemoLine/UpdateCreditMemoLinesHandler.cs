...
{
    public class UpdateCreditMemoLinesHandler : IRequestHandler<UpdateCreditMemoLines, int>
    {
        private readonly AccountingDbContext _dbContext;

        public UpdateCreditMemoLinesHandler(AccountingDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<int> Handle(UpdateCreditMemoLines request, CancellationToken cancellationToken)
        {
            ...
            var existingLines = await _dbContext.CreditMemoLines
            ...
            foreach (var existingLine in existingLines)
            {
                ...
                if (updateDto != null)
                {
                    ...
                    if (updateDto.CMID.HasValue)
                        existingLine.CMID = updateDto.CMID.Value;
