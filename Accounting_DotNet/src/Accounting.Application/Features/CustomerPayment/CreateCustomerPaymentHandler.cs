...
namespace Accounting.Application.Features
{
    public class CreateCustomerPaymentHandler : CreateEntityHandler<AccountingDbContext, CustomerPayment, Guid, CreateCustomerPayment, Guid>
    {
        ...
        public CreateCustomerPaymentHandler(AccountingDbContext dbContext, IMapper mapper, IFormSequenceService formSequenceService)
            : base(dbContext, mapper)
        {
            _formSequenceService = formSequenceService;
        }

        protected override async Task<CustomerPayment> CreateEntityAsync(CreateCustomerPayment request, IMapper mapper, CancellationToken cancellationToken)
        {
