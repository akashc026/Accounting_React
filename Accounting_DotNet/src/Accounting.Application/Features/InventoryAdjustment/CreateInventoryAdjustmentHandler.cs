...
namespace Accounting.Application.Features
{
    public class CreateInventoryAdjustmentHandler : CreateEntityHandler<AccountingDbContext, InventoryAdjustment, Guid, CreateInventoryAdjustment, Guid>
    {
        ...
        public CreateInventoryAdjustmentHandler(AccountingDbContext dbContext, IMapper mapper, IFormSequenceService formSequenceService)
            : base(dbContext, mapper)
        {
            _formSequenceService = formSequenceService;
        }

        protected override async Task<InventoryAdjustment> CreateEntityAsync(CreateInventoryAdjustment request, IMapper mapper, CancellationToken cancellationToken)
        {
