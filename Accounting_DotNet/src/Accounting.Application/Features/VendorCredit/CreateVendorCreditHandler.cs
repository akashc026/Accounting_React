...
namespace Accounting.Application.Features
{
    public class CreateVendorCreditHandler : CreateEntityHandler<AccountingDbContext, VendorCredit, Guid, CreateVendorCredit, Guid>
    {
        ...
        public CreateVendorCreditHandler(AccountingDbContext dbContext, IMapper mapper, IFormSequenceService formSequenceService) : base(dbContext, mapper)
        {
            _formSequenceService = formSequenceService;
        }

        protected override async Task<VendorCredit> CreateEntityAsync(CreateVendorCredit request, IMapper mapper, CancellationToken cancellationToken)
        {
