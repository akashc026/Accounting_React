...
{
    public class UpdateVendorPaymentLinesHandler : IRequestHandler<UpdateVendorPaymentLines, int>
    {
        private readonly AccountingDbContext _dbContext;

        public UpdateVendorPaymentLinesHandler(AccountingDbContext dbContext)
        {
            _dbContext = dbContext;
        }

        public async Task<int> Handle(UpdateVendorPaymentLines request, CancellationToken cancellationToken)
        {
            ...
            var existingLines = await _dbContext.VendorPaymentLines
